...
let st2 = new Street('hudson',1950,270,'huge');
let st3 = new Street('harrison',1990,220,'tiny');
...
console.log(`our ${streetArr.length} streets have a total length of
${totalLength} miles, with an average length of ${avgLength} miles`);

//size classification for each street
streetArr.forEach(el => console.log(`${el.name} street, built in ${el.buildYear}, is a ${el.size} street`));
